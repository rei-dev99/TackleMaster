...
class OpenaiService
  ...
  def self.create_prompt(params)
    <<~PROMPT
      ...
      - また「」に入るキーワードは釣り具の商品名だけの入力としてください。メーカー名は入れないでください。
      - 具体的な釣り具名を提示の際には、改行せずに1行に繋げて記述してください。
      - 出力フォーマットの【】にはユーザーが入力したものを入れてください。
      - 釣り具の種類がロッド、リール、ライン、ルアーなら、それ単体だけで提案で、タックル一式なら、ロッド、リール、ライン、ルアーを提案し、その他にあったら良いものも提案してください。
